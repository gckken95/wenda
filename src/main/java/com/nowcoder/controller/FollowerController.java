...
public class FollowerController {
    ...
    public String followers(Model model,@PathVariable("uid")int userId){
        List<Integer> followerIds=followService.getFollowers(EntityType.ENTITY_USER,hostHolder.getUser().getId(),0,10);
        if(hostHolder.getUser()!=null){
    ...
    private List<ViewObject> getUsersInfo(int loacalUserId,List<Integer> userIds){
        ...
        for(Integer uid:userIds){
            ...
            if(loacalUserId!=0){
                vo.set("follower",followService.isFollower(loacalUserId,EntityType.ENTITY_USER,uid));
            }else{
                vo.set("follower",false);
            }
            userInfos.add(vo);
        }
        return userInfos;
